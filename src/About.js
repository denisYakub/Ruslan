    ...
    return (<div className="About">
        ...
        <div className="Preview-Info-Blocks">
            ...
            <div className="Preview-Info-Block-Violet">
                ...
                <span>Мы вместе с нашими пользователями постоянно стараемся находить интересные занятия. Так что помимо самой игры на проекте, Вы точно найдёте друзей со схожими идеями и интересами! Наш чат открыт для всех!</span>
            </div>
        </div>
